...
public class FairDataLoaderStepMeta extends BaseStepMeta implements StepMetaInterface {
	...
	public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
		...
		return new FairDataLoaderStep(stepMeta, stepDataInterface, copyNr, transMeta, trans);
	}

	public StepDataInterface getStepData() {
		return new FairDataLoaderStepData();
	}

	@Override
	public String getDialogClassName() {
		return FairDataLoaderStepDialog.class.getName();
	}
