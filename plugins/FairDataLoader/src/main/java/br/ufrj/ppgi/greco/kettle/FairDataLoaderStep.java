...
public class FairDataLoaderStep extends BaseStep implements StepInterface {
	...
	public FairDataLoaderStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
	...
	public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
		...
		FairDataLoaderStepMeta meta = (FairDataLoaderStepMeta) smi;
		FairDataLoaderStepData data = (FairDataLoaderStepData) sdi;
		...
		if (row == null) { // Nao ha mais linhas de dados
			...
			i=0;
			outputRow=RowDataUtil.addValueData(outputRow, i++,"http://localhost/n");
	...
	public void processaTriplas(String resultadoGet, Object[] saidaProc, FairDataLoaderStepData dataStep) throws IOException, KettleStepException{
		String outputTot="";
        Statement statement;
        StringReader r;
	...
	private String gravaDados(String fdpURL, String content, String type, String user, String pass) throws IOException {//requisita autenticação por meio da função com esse fim e constroi POST para carga de dados
        ...
        HttpPost postRequest = new HttpPost(fdpURL+"/"+type);//Type of POST on FDP catalog, dataset or collection
