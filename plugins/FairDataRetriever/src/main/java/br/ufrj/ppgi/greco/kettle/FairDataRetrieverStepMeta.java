...
public class FairDataRetrieverStepMeta extends BaseStepMeta implements StepMetaInterface {
	...
	public FairDataRetrieverStepMeta() {
		setDefault();
	}
	...
	public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
		...
		return new FairDataRetrieverStep(stepMeta, stepDataInterface, copyNr, transMeta, trans);
	}

	public StepDataInterface getStepData() {
		return new FairDataRetrieverStepData();
	}

	@Override
	public String getDialogClassName() {
		return FairDataRetrieverStepDialog.class.getName();
	}
