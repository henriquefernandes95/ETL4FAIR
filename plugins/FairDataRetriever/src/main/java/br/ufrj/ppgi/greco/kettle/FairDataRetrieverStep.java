...
public class FairDataRetrieverStep extends BaseStep implements StepInterface {

	

	private boolean finished=false;

	public FairDataRetrieverStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
	...
	public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
		...
		FairDataRetrieverStepMeta meta = (FairDataRetrieverStepMeta) smi;
		FairDataRetrieverStepData data = (FairDataRetrieverStepData) sdi;
	...
	public void processaTriplas(String resultadoGet, Object[] saidaProc, FairDataRetrieverStepData dataStep) throws IOException, KettleStepException{
		String outputTot="";
        Statement statement;
        StringReader r;
